...
part of 'ignore_device_completed_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

IgnoreDeviceCompletedResponse _$IgnoreDeviceCompletedResponseFromJson(
    Map<String, dynamic> json) {
  return IgnoreDeviceCompletedResponse(
    status:
...
Map<String, dynamic> _$IgnoreDeviceCompletedResponseToJson(
        IgnoreDeviceCompletedResponse instance) =>
    <String, dynamic>{
